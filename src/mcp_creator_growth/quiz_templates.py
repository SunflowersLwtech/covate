...
Provides default quiz templates based on change types.
Separated from server logic for better organization and easier updates.
"""

from typing import Any


def get_default_quizzes(change_type: str) -> list[dict[str, Any]]:
    """
    Generate default quiz questions based on change type.

    Args:
        change_type: Detected type of change (bugfix, performance, refactor, etc.)
