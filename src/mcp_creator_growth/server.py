...
from .quiz_templates import get_default_quizzes
from .utils.filesystem import ensure_project_directory
...
def _generate_default_quizzes(summary: str) -> list[dict[str, Any]]:
    ...
    return get_default_quizzes(change_type)
...
async def learning_session(
    ...
    project_directory = ensure_project_directory(project_directory)
